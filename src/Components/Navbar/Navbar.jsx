              ...
              {loading ? (
                ...
                <div className="dropdown dropdown-end">
                  ...
                  >
                    ...
                    >
                      <img
                        className="w-25 mx-auto rounded-full overflow-hidden border border-primary"
                        src={
                          user?.photoURL ||
                          "https://sanishtech.com/i/6918a48ec775c7.75838870-1763222670.png"
                        }
                    ...
                    <NavLink
                      to={`/challenges-add`}
                      className={" text-center font-semebold hover:underline"}
                    >
                      Add Challenges
                    </NavLink>
                    ...
                    <button
                      onClick={signOutUser}
                      className={
                        "btn bg-[#297B33] hover:bg-[#82B532]  text-white"
                      }
                    >
                      Sign Out
                    </button>
